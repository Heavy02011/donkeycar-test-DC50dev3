...
# 
# #CAMERA
CAMERA_TYPE = "CSIC" #PICAM"   # (PICAM|WEBCAM|CVCAM|CSIC|V4L|D435|MOCK|IMAGE_LIST)
#IMAGE_W = 224 #160
#IMAGE_H = 224 #120
IMAGE_W = 160
IMAGE_H = 120
...
#
DRIVE_TRAIN_TYPE = "I2C_SERVO" #"PWM_STEERING_THROTTLE"
# 
# #
...
STEERING_LEFT_PWM = 480 #460         #pwm value for full left steering
# zero steering 390
STEERING_RIGHT_PWM = 290        #pwm value for full right steering
THROTTLE_CHANNEL = 0            #(deprecated) channel on the 9685 pwm board 0-15
THROTTLE_FORWARD_PWM = 560      #pwm value for max forward throttle
THROTTLE_STOPPED_PWM = 420 #370      #pwm value for no movement
THROTTLE_REVERSE_PWM = 220 #250 #290 #310# 220      #pwm value for max reverse throttle
# 
# #
...
#
AXLE_LENGTH  = 0.26   # 0.03   # length of axle; distance between left and right wheels in meters
WHEEL_BASE   = 0.285  # 0.1    # distance between front and back wheels in meters
WHEEL_RADIUS = 0.054  # 0.0315 # radius of wheel in meters
...
HAVE_ODOM_2 = True             # Do you have a second odometer/encoder as in a differential drive robot.
                                # In this case, the 'first' encoder is the left wheel encoder and
                                # the second encoder is the right wheel encoder.
ENCODER_TYPE = 'arduino'           # What kind of encoder? GPIO|arduino.
...
ENCODER_PPR = 5                # encoder's pulses (ticks) per revolution of encoder shaft.
ENCODER_DEBOUNCE_NS = 10         # nanoseconds to wait before integrating subsequence encoder pulses.
...
BATCH_SIZE = 1#8#16 # 8 #128                #how many records to use when doing one pass of gradient decent. Use a smaller number if your gpu is running out of memory.
