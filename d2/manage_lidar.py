...
from donkeycar.parts.lidar import LidarProcessor #rbx
...
def drive(cfg, model_path=None, use_joystick=False, model_type=None,
    ...
    if cfg.USE_LIDAR:
        ...
        if cfg.LIDAR_TYPE == 'RP':
            ...
            lidar_processor = LidarProcessor('lidar/dist_array',cfg.IMAGE_H, cfg.IMAGE_W) #(cfg.LIDAR_H, cfg.LIDAR_W)
            V.add(lidar_processor, inputs=['lidar/dist_array'],outputs=['lidar/image_array'], threaded=True)
    ...
    if cfg.USE_LIDAR:
        ...
        #rbx
        ###inputs = ['cam/image_array', 'lidar/image_array','lidar/dist_array', 'user/angle', 'user/throttle', 'user/mode']
